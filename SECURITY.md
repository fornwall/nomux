...
[§ P3](PLAN.md#p3--release-process)'s: a `v*` tag publishes the per-architecture
checksums as release assets, but nothing verifies an uploaded binary against them
yet, that half being the client's.
